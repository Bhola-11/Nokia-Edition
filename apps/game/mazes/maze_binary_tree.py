"""
Maze Generation Engine: BinaryTreeBiasMazeGenerator
Description: Directionally biased binary tree partitioner
"""
...
class BinaryTreeBiasMazeGenerator:
    """Implementation of Directionally biased binary tree partitioner."""
