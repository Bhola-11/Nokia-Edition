"""
Maze Generation Engine: AldousBroderMazeGenerator
Description: Pure uniform random walk spanning tree generator
"""
...
class AldousBroderMazeGenerator:
    """Implementation of Pure uniform random walk spanning tree generator."""
