"""
AI Module: MinimaxLookaheadBot
Description: Minimax depth-search with alpha-beta pruning
"""
...
class MinimaxLookaheadBot:
    """Implementation of Minimax depth-search with alpha-beta pruning for autonomous snake navigation."""
