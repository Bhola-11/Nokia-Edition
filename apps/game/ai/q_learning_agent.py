"""
AI Module: QLearningSnakeAgent
Description: Tabular Q-learning model with state discretization
"""
...
class QLearningSnakeAgent:
    """Implementation of Tabular Q-learning model with state discretization for autonomous snake navigation."""
