"""
RPG Subsystem: EquipmentInventoryManager
Description: Scale armor, fangs, rings, charms and tail attachments
"""
...
class EquipmentInventoryManager:
    """Implementation of Scale armor, fangs, rings, charms and tail attachments."""
