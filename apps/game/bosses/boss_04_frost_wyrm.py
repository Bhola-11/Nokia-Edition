"""
Boss Encounter Module: Frost Wyrm (Boss #4)
Description: Freezes trail into solid obstacle ice blocks
"""
...
class BossEncounter_frost_wyrm:
    ...
    def compute_boss_action_tick(self, player_head: Tuple[int, int], tick: int) -> Dict[str, Any]:
        ...
        return {"new_head": new_head, "attack_fired": tick % 16 == 0}
