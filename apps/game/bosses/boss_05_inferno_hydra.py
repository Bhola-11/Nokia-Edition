"""
Boss Encounter Module: Inferno Hydra (Boss #5)
Description: Splits into twin heads when reaching half HP
"""
...
class BossEncounter_inferno_hydra:
    ...
    def compute_boss_action_tick(self, player_head: Tuple[int, int], tick: int) -> Dict[str, Any]:
        ...
        return {"new_head": new_head, "attack_fired": tick % 15 == 0}
