"""
Boss Encounter Module: Dune Sandcrawler (Boss #9)
Description: Burrows under floor and erupts under apples
"""
...
class BossEncounter_dune_crawler:
    ...
    def compute_boss_action_tick(self, player_head: Tuple[int, int], tick: int) -> Dict[str, Any]:
        ...
        return {"new_head": new_head, "attack_fired": tick % 11 == 0}
