"""
Boss Encounter Module: Venom Mamba (Boss #7)
Description: Leaves toxic slime puddles requiring spatial routing
"""
...
class BossEncounter_venom_mamba:
    ...
    def compute_boss_action_tick(self, player_head: Tuple[int, int], tick: int) -> Dict[str, Any]:
        ...
        return {"new_head": new_head, "attack_fired": tick % 13 == 0}
