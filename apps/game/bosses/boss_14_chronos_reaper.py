"""
Boss Encounter Module: Chronos Reaper (Boss #14)
Description: Reverses time and rewinds eaten apples
"""
...
class BossEncounter_chronos_reaper:
    ...
    def compute_boss_action_tick(self, player_head: Tuple[int, int], tick: int) -> Dict[str, Any]:
        ...
        return {"new_head": new_head, "attack_fired": tick % 6 == 0}
