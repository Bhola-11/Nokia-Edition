"""
Tournament Module: SeasonalRewardDistributor
Description: XP, badges and cosmetic distribution at season end
"""
...
class SeasonalRewardDistributor:
    """Implementation of XP, badges and cosmetic distribution at season end."""
